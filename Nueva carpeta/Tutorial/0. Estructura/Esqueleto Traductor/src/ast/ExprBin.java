...
//	exprBin:expression -> left:expression  operator:String  right:expression

public class ExprBin extends AbstractExpression {

	public ExprBin(Expression left, String operator, Expression right) {
		this.left = left;
	...
	public ExprBin(Object left, Object operator, Object right) {
