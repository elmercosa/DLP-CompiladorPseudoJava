...
public class Lexicon extends Lexer {
	...
	public static final int
		INT_CONSTANT=1, REAL_CONSTANT=2, MAS=3, MENOS=4, IGUAL=5, PTO_COMA=6, 
	...
	public static final String[] ruleNames = {
		"INT_CONSTANT", "REAL_CONSTANT", "MAS", "MENOS", "IGUAL", "PTO_COMA", 
	...
	private static final String[] _SYMBOLIC_NAMES = {
		null, "INT_CONSTANT", "REAL_CONSTANT", "MAS", "MENOS", "IGUAL", "PTO_COMA", 
		"READ", "WRITE", "INT", "FLOAT", "IDENT", "LINE_COMMENT", "MULTILINE_COMMENT", 
		"WHITESPACE"
	};
